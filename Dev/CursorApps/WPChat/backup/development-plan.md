...
- Review and refine system prompt for conciseness and token efficiency.
- Add LLM API parameters (`temperature`, `top_p`, `max_tokens`) to the AJAX handler for better response control.
