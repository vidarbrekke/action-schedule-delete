                    ...
                    <tr>
                        ...
                        <td>
                            <div class="notice notice-info inline">
                                <p><?php _e('Caching is currently disabled to ensure fresh processing of each URL. The settings below will not take effect until caching is re-enabled in the code.', 'url-to-gutenberg'); ?></p>
                            </div>
                            <fieldset>
